...
function sendThankYouEmail(email) {
  ...
  var mailOptions = {
    from: 'AquaAsCCG Inc.',
    to: email,
    subject: 'New supplyment of product and website going online',
    text: 'Important news; New shipments of product coming in few day. Please dont worry if we not having a certain prduct. It will be comingin soon. Our website will be opened to the public in the near future. please  be patient.',
    html: '<h1>AquaAsCCG Inc.</h1><p>Important news for company</p>'
  };
  return mail.send(mailOptions).then(function() {
    console.log('New company news email sent to: ' + email);
  });
}
/**
